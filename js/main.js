...
const linkAction = () => {
    const navMenu = document.getElementById('nav-menu')
    //! when we click in each navLink we remove the showMenu
    navMenu.classList.remove('show-menu')
}
...
const sections = document.querySelectorAll('sectiom[id')
const scrollActive = () => {
...
sr.reveal(`.recipe__img, .delivery__img, .contact__data`, { origin: 'left' })
